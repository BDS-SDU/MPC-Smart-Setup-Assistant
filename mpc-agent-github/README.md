...
Semi2k-family configurations are available as `semi2k` / `mp_spdz_semi2k` for MP-SPDZ, `spu_semi2k` for SecretFlow SPU, and `crypten_semi2k` for the CrypTen runner.
