...
def _infer_math_structure(text: str, circuit_domain: str, secret_sharing: str) -> str:
    explicit = _choose_from_keywords(
        text,
        {
            "ring": [" ring ", "环", "mod 2^", "2^k", "ring-based", "semi2k", "semi-2k", "semi 2k"],
...
def _infer_secret_sharing(text: str) -> str:
    return _choose_from_keywords(
        text,
        {
            "additive": ["additive sharing", "additive secret sharing", "加法共享", "semi2k", "semi-2k", "semi 2k"],
...
def _infer_security_model(text: str) -> str:
    return _choose_from_keywords(
        text,
        {
            ...
            "semi_honest": ["semi-honest", "semi honest", "半诚实", "honest-but-curious", "semi2k", "semi-2k", "semi 2k"],
        },
        fallback="malicious",
    ) or "malicious"
